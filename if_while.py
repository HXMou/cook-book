...
while item_weight != 0:
    if 11 > item_weight >0:
        ...
        if package_weight > MAX:
            package_num += 1
            unsend = MAX + item_weight - package_weight
            total_unsend += unsend
            package_weight = item_weight
        ...
        print(f"total weight in current package: {package_weight}, package number:{package_num}, unsend: {unsend}")
